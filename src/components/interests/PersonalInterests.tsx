  ...
  const interests: Interest[] = [
    {
      ...
      description:
        "I love playing Piano and Guitar, expressing creativity through music and sharing performances with others.",
      icon: <MusicNoteIcon />,
      category: "music",
      links: [
        {
    ...
    },
    {
      ...
      description:
        "Have great interest in game development. Developed multiple games during undergraduation and continue exploring new technologies.",
    ...
    },
    {
      ...
      description:
        "Love exploring new features such as AR, VR, 3D Modeling, and Environment design. Always staying up to date with the latest developments.",
      icon: <BuildIcon />,
      category: "development",
    ...
    },
    {
      ...
      description:
        "Love listening to songs and finding new ones. Music is a constant source of inspiration and relaxation.",
      icon: <MusicIcon />,
      category: "music",
      links: [
        {
    ...
    },
    {
      ...
      description:
        "Playing competitive video games such as Valorant, Overwatch and watching streamers play. Enjoy the strategic and competitive aspects.",
      icon: <GamingIcon />,
      category: "gaming",
    ...
    },
    {
      ...
      description:
        "Love to watch anime and reading manga, appreciating the storytelling, art style, and cultural aspects of Japanese animation.",
      icon: <AnimeIcon />,
    ...
    <Box>
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
                      <Box
                        sx={{
                          ...
                          borderRadius: 2,
                          backgroundColor:
                            getCategoryColor(interest.category) + "20",
                        ...
                        {interest.links.map((link, index) => (
                          <Button
                            ...
                            sx={{
                              ...
                              "&:hover": {
                                backgroundColor:
                                  getCategoryColor(interest.category) + "10",
      ...
      >
        ...
        <Typography
          ...
          sx={{ lineHeight: 1.6 }}
        >
          These diverse interests contribute to my holistic approach to
          problem-solving and creativity. Whether it's the precision required in
          musical performance, the strategic thinking in competitive gaming, or
          the artistic vision in game development, each interest enhances my
