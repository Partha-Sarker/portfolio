...
const PersonalProjects: React.FC<PersonalProjectsProps> = ({ projects }) => {
  ...
  const webToolProjects = personalProjects.filter(
    (project) =>
      project.technologies.some((tech) =>
        ["Node.js", "JavaScript", "Python", "Spring"].includes(tech),
      ) &&
      !project.technologies.some((tech) =>
        tech.toLowerCase().includes("unity"),
      ),
  );
  ...
  const otherProjects = personalProjects.filter(
    (project) =>
  ...
  return (
    <Box>
      ...
      <Typography variant="body1" color="text.secondary" sx={{ mb: 4 }}>
        These self-initiated projects reflect my passion for technology,
        creativity, and continuous learning. They demonstrate initiative,
        problem-solving skills, and exploration of diverse technical domains
        ...
        <Box sx={{ mb: 5 }}>
          ...
          >
            <Typography
              ...
              sx={{ fontStyle: "italic" }}
            >
              These projects combine my technical skills with creative
              interests, particularly in music and augmented reality, showcasing
      ...
      >
        ...
        >
          <Box>
            ...
            >
              These projects demonstrate my commitment to continuous learning
              and exploration of new technologies beyond formal education
              requirements.
            </Typography>
          ...
          <Box>
            ...
            <Typography
              ...
              sx={{ lineHeight: 1.6, mb: 2 }}
            >
              Several projects connect to my research interests, particularly in
              HCI (AR Girl), automation (CS Ranking Crawler), and creative
