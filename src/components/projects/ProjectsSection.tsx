...
const ProjectsSection: React.FC<ProjectsSectionProps> = ({ projects }) => {
  ...
  const filterProjects = (projectList: Project[]) => {
    return projectList.filter((project) => {
      ...
      const matchesTag =
        technologyFilter === "" || project.tags.includes(technologyFilter);
        ...
        {(searchTerm || technologyFilter) && (
          ...
          >
            <Typography
              ...
              sx={{ mr: 1, fontSize: { xs: "0.8rem", sm: "0.875rem" } }}
            >
              Active filters:
            </Typography>
            {searchTerm && (
      ...
      {!searchTerm && !technologyFilter && (
        <Box sx={{ borderColor: "divider", mb: 3 }}>
          ...
          >
            <Tab
              icon={
                <StarIcon sx={{ fontSize: { xs: "1rem", sm: "1.2rem" } }} />
              }
              iconPosition="start"
            ...
            <Tab
              icon={
                <ScienceIcon sx={{ fontSize: { xs: "1rem", sm: "1.2rem" } }} />
              }
              iconPosition="start"
            ...
            <Tab
              icon={
                <SchoolIcon sx={{ fontSize: { xs: "1rem", sm: "1.2rem" } }} />
              }
              iconPosition="start"
            ...
            <Tab
              icon={
                <WorkIcon sx={{ fontSize: { xs: "1rem", sm: "1.2rem" } }} />
              }
              iconPosition="start"
            ...
            <Tab
              icon={
                <PersonIcon sx={{ fontSize: { xs: "1rem", sm: "1.2rem" } }} />
              }
              iconPosition="start"
