            ...
            <CardContent sx={{ p: 4 }}>
                  ...
                  >
                    ...
                    <Box sx={{ mb: 2 }}>
                      ...
                      <Typography variant="body2" color="text.secondary">
                        Conducted a user study (n=109) followed by a 3-week
                        experiment with 16 volunteers using the "App Usage
                        Monitor" Android application. Combined usage tracking,
                        visualization, and strategic notifications to increase
                        self-awareness and reduce excessive smartphone use.
                      </Typography>
                    </Box>
              ...
              <Box sx={{ mt: 4 }}>
                <Button
                  ...
                  endIcon={
                    showPriorEducation ? <ExpandLessIcon /> : <ExpandMoreIcon />
                  }
                  sx={{
                    color: "text.secondary",
                    textTransform: "none",
                    ...
                    {education
                      ...
                      .map((priorEdu) => (
                        ...
                        >
                          ...
                          {priorEdu.achievements &&
                            priorEdu.achievements.length > 0 && (
                              <Box sx={{ mt: 1 }}>
                                <Typography
                                  variant="body2"
                                  color="text.secondary"
        ...
        <Card elevation={2} sx={{ borderRadius: 2 }}>
          <CardContent sx={{ p: 3 }}>
            ...
            <Typography variant="body1" sx={{ mb: 2 }}>
              Conducted three specialized sessions on machine learning
              algorithms and techniques for undergraduate students:
            </Typography>
