...
const Skills: React.FC = () => {
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      case "programming":
        return <CodeIcon sx={{ mr: 1, color: theme.palette.primary.main }} />;
      case "frameworks":
        return <BuildIcon sx={{ mr: 1, color: theme.palette.primary.main }} />;
      case "ml":
        return (
          <SmartToyIcon sx={{ mr: 1, color: theme.palette.primary.main }} />
        );
      case "cloud":
        return <CloudIcon sx={{ mr: 1, color: theme.palette.primary.main }} />;
      case "databases":
        return (
  ...
  const getCategoryTitle = (category: string) => {
    switch (category) {
      ...
      case "databases":
        return "Databases";
      case "tools":
        return "Development Tools & Technologies";
      case "design":
        return "Design & Creative Tools";
      case "research":
        return "Research & Academic Skills";
      case "soft":
        return "Soft Skills";
      default:
        return "Skills";
  ...
  const SkillsSection: React.FC<{ category: string; skillsList: any[] }> = ({
    category,
    skillsList,
  }) => (
    <Box sx={{ mb: 6 }}>
    ...
    <Grid container spacing={3}>
      <Grid sx={{ xs: 12 }}>
        ...
        <SkillsSection
          ...
          skillsList={skillsByCategory.programming}
        />

        {/* Frameworks & Libraries */}
        <SkillsSection
          category="frameworks"
          skillsList={skillsByCategory.frameworks}
        />
        ...
        <SkillsSection
          category="databases"
          skillsList={skillsByCategory.databases}
        />
        ...
        <SkillsSection
          category="research"
          skillsList={skillsByCategory.research}
        />
