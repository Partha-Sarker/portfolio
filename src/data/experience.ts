...
const experience: Experience[] = [
  {
    ...
    endDate: "Present",
    description:
      "Working on MarginEdge, a comprehensive restaurant management software that streamlines back-office operations and enhances financial oversight with real-time insights into food and labor costs.",
    responsibilities: [
  ...
  },
  {
    ...
    endDate: "July 2024",
    description:
      "Worked on large-scale national digital platforms for the Government of Bangladesh, contributing to systems that serve millions of citizens and students across the country.",
    projects: [
      {
        id: "ieims",
        name: "IEIMS (Integrated Education Information Management System)",
        description:
          "A national digital platform developed by the Ministry of Education, Bangladesh, to centralize and streamline the management of secondary and higher secondary education serving over 20 million students across the country.",
        responsibilities: [
      ...
      },
      {
        ...
        description:
          "A national system in Bangladesh for recording and managing vital events such as births, deaths, marriages, and divorces. The system integrates with various government platforms and supports over 10 million students.",
        responsibilities: [
